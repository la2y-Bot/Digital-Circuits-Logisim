...
A collection of digital circuits built using Logisim for learning and demonstration.
# Digital Circuits with Logisim
...
1. **Install Logisim**  
   - Download Logisim from [Logisim official site](http://www.cburch.com/logisim/).  
   - Open `.circ` files directly in Logisim.

2. **Clone the Repository**
   ```bash
   git clone https://github.com/your-username/Digital-Circuits-Logisim.git
   cd Digital-Circuits-Logisim```
3. 	Explore Circuits
...
- Showcase practical skills in digital design and verification
